/* ============================================================
   1. ANIMASI CANVAS MATRIX RAIN (HEMAT DAYA & RESPONSIVE)
   ============================================================ */
...
// Pause animasi Matrix saat tab browser tidak aktif untuk menghemat daya
...
window.addEventListener('DOMContentLoaded', () => {
  document.body.style.overflow = 'hidden'; // Kunci scroll saat loading boot
  ...
  const logs = [
    "Checking ESP32 Core Architecture...",
...
// Inisialisasi preferensi bahasa yang tersimpan
...
// Auto-focus ke input saat area terminal diklik di mana saja
...
- <span class="highlight-cmd">upcoming</span> : Bocoran status proyek rahasia Horizon-X
- <span class="highlight-cmd">skills</span>   : Tech stack hardware & software
- <span class="highlight-cmd">socials</span>  : Daftar tautan media sosial resmi
...
Repo: https://github.com/adaptivehorizon51/A.H51-esp32`,
  ...
  upcoming: () => `[CLASSIFIED R&D // TOP SECRET]
Project Codename: Horizon-X
Controller: ESP32 Master Architecture
Status    : Confidential Prototype Testing.
Detail cara kerja, fitur lengkap, dan skema sirkuit saat ini dirahsiakan.
Tekan tombol 'Buka Kunci Preview R&D' pada halaman web untuk melihat telemetri.`,

  skills: () => `Hardware: ESP32 Dual-Core, I2C Bus, LCD 1602, OLED 1.3", Sensor Array
...
/* ============================================================
   11. THEME TOGGLE (DENGAN PENYIMPANAN LOCALSTORAGE)
   ============================================================ */
...
// Muat tema yang tersimpan sebelumnya dari pengguna
